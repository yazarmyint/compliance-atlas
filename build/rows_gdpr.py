...
ROWS = [
    row("gdpr-5-1-c", "Art. 5(1)(c)", "Art. 5 Principles",
        "Data minimisation: personal data must be adequate, relevant, and limited to what the purpose requires.",
        ...
        "Evidences whether minimisation is holding in collaboration estates and gives the review a concrete target list. Minimisation decisions at collection points are application/process design.",
        "EU personal-data SITs scoped; recurring discovery",
        "Trended personal-data footprint reports feeding minimisation reviews",
    ...
    row("gdpr-5-2", "Art. 5(2)", "Art. 5 Principles",
        ...
        "Compliance Manager", "GDPR premium assessment tracking technical/organisational measures; Purview policy configuration + audit trail as demonstrable-compliance artifacts",
    ...
    row("gdpr-15", "Art. 15", "Arts. 15–20 Data subject rights",
        ...
        "Implements locate/collect/export for M365 content in access-request fulfilment. Intake, identity verification, redaction of third-party data, and response are process/Priva.",
    ...
    row("gdpr-25", "Art. 25", "Art. 25 By design",
        "Data protection by design and by default: embed technical/organisational measures (e.g., minimisation, pseudonymisation) into processing.",
        ...
        "Implements 'by default' concretely in M365: new content lands labelled, protected, retention-bound without user action. System/application design outside M365 is the broader obligation.",
        "Default label policy; auto-labeling; baseline DLP; default retention",
        "Coverage metrics: % content labelled by default; policy inventory",
    ...
    row("gdpr-32-1-a", "Art. 32(1)(a)", "Art. 32 Security",
        "Security of processing: pseudonymisation and encryption of personal data as risk-appropriate measures.",
        "Information Protection", "Label-based encryption on personal-data content (auto-applied); Customer Key/DKE options; SIT detection guarding pseudonymised sets against re-identification leakage",
        "Implements the encryption measure for personal data in M365 and evidences pseudonymisation hygiene. Database-layer crypto and pseudonymisation engineering are outside.",
        "Auto-label + encrypt on personal-data tiers; Customer Key where adopted",
        "Encrypted personal-data item distribution; RMS logs",
        "Application/database encryption; pseudonymisation tooling; key management",
    ...
    row("gdpr-32-1-d", "Art. 32(1)(d)", "Art. 32 Security",
        "Regularly test, assess, and evaluate the effectiveness of technical and organisational security measures.",
...
ROWS += [
    er("gdpr-32-1-b-entra", "Art. 32(1)(b)", "Art. 32 Security",
       ...
       "Implements access control and strong authentication as Art. 32 technical measures for Entra-integrated systems processing personal data. Encryption/pseudonymisation and non-Entra systems are complementary.",
       ...
       "Encryption/pseudonymisation of personal data; access control in non-Entra systems",
    ...
    er("gdpr-25-entra", "Art. 25", "Art. 25 By design",
       "Data protection by design and by default: implement appropriate technical and organisational measures such as access minimisation into processing.",
       "Entra ID Governance",
       "Least-privilege access packages, access reviews, and default-deny Conditional Access as by-default technical measures minimising who can access personal data",
       "Implements the access-minimisation dimension of data protection by default for Entra-governed systems: least privilege and recertification limit personal-data access. Broader privacy-by-design in app/system design is organizational.",
...
ROWS += [
    ir("gdpr-32-1-a-intune", "Art. 32(1)(a)", "Art. 32 Security",
       ...
       "Implements the device-layer encryption measure, a recognised technical and organisational measure (TOM) under Art. 32, for managed endpoints and mobile apps. Content-layer encryption in M365 is the Purview seam; pseudonymisation engineering and database crypto are external.",
       ...
       "Pseudonymisation tooling; application/database encryption; key management",
       "Partial Support", "High",
       INTUNE_LIC["p1"],
       None,
...
ROWS += [
    ...
    dr("gdpr-32-1-d-defender", "Art. 32(1)(d)", "Art. 32 Security",
       ...
       "Implements a continuously running test-assess-evaluate mechanism for the technical measures on the Microsoft estate, stacking with the Purview row's Compliance Manager evidence. Penetration testing, audits, and evaluation of organisational measures remain the broader program.",
       ...
       "Penetration testing and independent audits; evaluation of organisational measures",
       "Partial Support", "Medium",
...
ROWS += [
    ...
    sr("gdpr-32-1-d-sentinel", "Art. 32(1)(d)", "Art. 32 Security",
       ...
       "Evidences the regular-evaluation obligation for one class of technical measures (the organisation's detection and response capability), with artifacts a DPO can put in the Art. 32 file. It does not test the measures (no simulation or scanning); the stacked Defender row carries continuous technical assessment and the Purview row the structured assessment program.",
       ...
       "Penetration testing and audits; evaluation of organisational measures; assessment ownership",
...
ROWS += [
    ...
    mr("gdpr-32-1-d-mdc", "Art. 32(1)(d)", "Art. 32 Security",
       ...
       "Penetration testing and security audits; evaluation of organisational measures; DPO oversight and documentation",
       "Partial Support", "High",
       MDC_LIC["dashboard"],
       MDC_GOV["dashboard"],
