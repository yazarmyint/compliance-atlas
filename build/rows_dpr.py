...
ROWS = [
    ...
    row("dpr-f14-22", "F #14–22", "F Data Subjects",
        ...
        "Implements the locate/collect step of DSR fulfillment for M365 content and evidences the search actions taken. Request intake, decisioning, and response records are process/tooling outside core Purview.",
        "eDiscovery case + search configuration for DSR fulfillment",
        "Per-request search/export records; DSR fulfillment log",
    ...
    row("dpr-j36", "J #36", "J Security",
        ...
        "Adds a content-layer access restriction on labeled Microsoft data, a narrow contributor. The requirement's substance (accounts, MFA, lockout, 48-hour deprovisioning, access reviews) is identity-platform territory.",
    ...
    row("dpr-j40", "J #40", "J Security",
        "Run a DLP program: data classified, labeled, and protected; monitor systems processing Microsoft data for intrusions, loss, and unauthorized activity; program must include IDS/IPS, breach analysis, and offboarding communications.",
    ...
    row("dpr-j49", "J #49", "J Security",
        ...
        "Encrypted/labeled item counts from Data explorer; Azure RMS usage logs",
...
ROWS += [
    er("dpr-j36-entra", "J #36", "J Security",
       ...
       "Directly implements the identity core of J#36: MFA, lockout, session controls, strong credentials, and (via ID Governance) least-privilege review and deactivation. Content-layer restriction on labeled Microsoft data is the Purview seam.",
       ...
       [rel("purview", "contributing", "Sensitivity-label encryption adds a content-layer access restriction on labeled Microsoft data", "Information Protection")],
